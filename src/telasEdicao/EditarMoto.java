 ...
 * @author alamtrindade
 */
public class EditarMoto extends javax.swing.JFrame {
     ...
     */
    public EditarMoto(iVeiculo veiculos, Cliente cliente, Moto moto) {
        initComponents();
        ...
        inputPlaca.setText(moto.getPlaca());
        inputMarca.setText(moto.getMarca());
        inputModelo.setText(moto.getModelo());
        inputAno.setText(Integer.toString(moto.getAno()));
        inputCor.setText(moto.getCor());
        inputPorte.setText(moto.getPorte());
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (gravar == true) {
            ...
            moto.setMarca(inputMarca.getText());
            moto.setModelo(inputModelo.getText());
            moto.setCor(inputCor.getText());
            moto.setAno(Integer.parseInt(inputAno.getText()));
            moto.setPorte(inputPorte.getText());

            if (b.atualizarMoto(moto)) {
                JOptionPane.showMessageDialog(rootPane, "Veiculo " + moto.getPlaca() + " atualizado com sucesso!");
                veiculos.Listagem();
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(rootPane, "Veiculo " + moto.getPlaca() + " não atualizado, validar se os campos estão corretos!");
            }
