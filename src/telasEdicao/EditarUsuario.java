...
public class EditarUsuario extends javax.swing.JFrame {
     ...
     */
    public EditarUsuario(iUsers user, Usuario usuarios) {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (gravar == true) {
            ...
            usuario.setEndereco(inputEndereco.getText());
            usuario.setTelefone(inputTelefone.getText());
            usuario.setEmail(inputEmail.getText());
            usuario.setSenha(inputPassword.getText());

            if (b.atualizarUsuario(usuario)) {
                JOptionPane.showMessageDialog(rootPane, "Usuario " + usuario.getNome() + " atualizado com sucesso!");
                users.atualizarTabela();
                this.dispose();

            } else {
                JOptionPane.showMessageDialog(rootPane, "Usuario " + usuario.getNome() + " não atualizado, validar se já não existe ou se os campos estão corretos!");
            }
