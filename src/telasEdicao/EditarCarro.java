...
public class EditarCarro extends javax.swing.JFrame {
     ...
     */
    public EditarCarro(iVeiculo veiculo, Cliente cliente, Carro carro) {
        initComponents();
        ...
        inputPlaca.setText(carro.getPlaca());
        inputMarca.setText(carro.getMarca());
        inputModelo.setText(carro.getModelo());
        inputAno.setText(Integer.toString(carro.getAno()));
        inputCor.setText(carro.getCor());
        inputCategoria.setText(carro.getCategoria());
        inputPortas.setValue(carro.getPortas());
    }
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (gravar == true) {
            carro.setPlaca(inputPlaca.getText());
            carro.setMarca(inputMarca.getText());
            carro.setModelo(inputModelo.getText());
            carro.setCor(inputCor.getText());
            carro.setAno((Integer.parseInt(inputAno.getText())));
            carro.setCategoria(inputCategoria.getText());
            carro.setPortas(Integer.parseInt(inputPortas.getValue().toString()));

            //capturar por certeza o cliente
            if (b.atualizarCarro(carro)) {
                JOptionPane.showMessageDialog(rootPane, "Veiculo " + carro.getPlaca() + " atualizado com sucesso!");
                veiculos.Listagem();
                this.dispose();
            } else {
                JOptionPane.showMessageDialog(rootPane, "Veiculo " + carro.getPlaca() + " não atualizado, validar se já não existe ou se os campos estão corretos!");
            }
