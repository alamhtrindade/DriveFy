...
public class EditarProduto extends javax.swing.JFrame {
     ...
     */
    public EditarProduto(iProdutos prods, Produto produtos) {
        initComponents();
        this.setVisible(true);
        prod = prods;
        produto = produtos;
        
        inputTipo.setText(produto.getTipo());
        inputDescricao.setText(produto.getDescricao());
        inputQuantidade.getModel().setValue(produto.getQuantidade());
        inputPreco.setText(Double.toString(produto.getValor()));
    }
