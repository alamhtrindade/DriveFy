 ...
 * @author alamtrindade
 */
public class CadastrarPesados extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        if (gravar == true) {
            ...
            int eixos = Integer.parseInt((String) comboEixos.getSelectedItem());
            String cacamba = (String) comboCacamba.getSelectedItem();

            Pesado pesado = new Pesado(placa, marca, modelo, ano, cor, eixos, cacamba, infoCPF.getText());

            if (b.cadastrarPesado(pesado)) {
                JOptionPane.showMessageDialog(rootPane, "Veiculo " + pesado.getPlaca() + " cadastrado com sucesso!");

                this.dispose();
            } else {
                JOptionPane.showMessageDialog(rootPane, "Veiculo " + pesado.getPlaca() + " não cadastrado, validar se já não existe ou se os campos estão corretos!");
            }
