...
import telasEdicao.EditarUsuario;
 ...
 * @author alamtrindade
 */
public class ListarUsuarios extends javax.swing.JFrame implements iUsers {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Listar Usuários");
        ...
        if (linha >= 0) {
            ...
            for (Usuario a : usuarios) {
                ...
                if (a.getId() == id) {
                    ...
                    new EditarUsuario(this, a);
                    break;
                }else {

                    JOptionPane.showMessageDialog(rootPane, "A selecao atual não encontrou nenhum dado!");
                }
            ...
            for (Usuario a : usuarios) {
                ...
                if (a.getId() == id) {
                    ...
                    if (n == 0) {
                        ...
                        if (b.apagarUsuario(a)) {
                            JOptionPane.showMessageDialog(rootPane, "Usuario apagado com sucesso!");
                            carregar();
                            
                        } else {
                            JOptionPane.showMessageDialog(rootPane, "Não foi possivel excluir Usuario!");
                        }
                    }
                } else {

                    JOptionPane.showMessageDialog(rootPane, "A selecao atual não encontrou nenhum Usuario!");
                }
