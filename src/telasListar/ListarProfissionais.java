...
import telasEdicao.EditarProfissional;
 ...
 * @author alamtrindade
 */
public class ListarProfissionais extends javax.swing.JFrame implements iProfissional {
    ...
    public void carregar() {
        ...
        profissionais = b.CarregaProfissional();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Listar Profissionais");
            ...
            for (Profissional a : profissionais) {
                ...
                if (a.getId() == id) {
                    ...
                    int n = JOptionPane.showOptionDialog(null,
                            "Deseja excluir o profissional " + a.getNome() + " (CPF = " + a.getCpf() + ")? ",
                            "Excluir", JOptionPane.YES_NO_OPTION,
                            JOptionPane.QUESTION_MESSAGE, null, options, options[0]);

                    if (n == 0) {

                        if (b.apagarProfissional(a)) {
                            JOptionPane.showMessageDialog(rootPane, "Colaborador apagado com sucesso!");
                            carregar();

                        } else {
                            JOptionPane.showMessageDialog(rootPane, "Não foi possivel excluir colaborador!");
                        }
                    }
                } else {

                    JOptionPane.showMessageDialog(rootPane, "A selecao atual não encontrou nenhum colaborador!");
                }
